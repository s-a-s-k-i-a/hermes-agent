...
def select_provider_and_model(args=None):
    ...
    elif selected_provider == "kimi-code":
        _model_flow_kimi_code(config, current_model)
...
def _build_provider_choices() -> list[str]:
    ...
    try:
        ...
        return [
            "auto", "openrouter", "nous", "openai-codex", "xai-oauth", "copilot-acp", "kimi-code", "copilot",
